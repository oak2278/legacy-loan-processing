...
DBCC CHECKIDENT ('LoanApplications', RESEED, 1);
DBCC CHECKIDENT ('LoanDecisions', RESEED, 1);
DBCC CHECKIDENT ('PaymentSchedules', RESEED, 1);
DBCC CHECKIDENT ('InterestRates', RESEED, 1);

PRINT '✓ Existing data cleared';
PRINT '';

-- ============================================================================
-- Insert all sample data within a transaction for atomicity
-- ============================================================================
BEGIN TRY
    BEGIN TRANSACTION;
    ...
    -- Query actual ApplicationId values from inserted data instead of hardcoding
    DECLARE @App7 INT, @App8 INT, @App9 INT, @App10 INT, @App11 INT, @App12 INT, @App13 INT, @App14 INT;
    SELECT @App7 = ApplicationId FROM LoanApplications WHERE ApplicationNumber LIKE '%00007';
    SELECT @App8 = ApplicationId FROM LoanApplications WHERE ApplicationNumber LIKE '%00008';
    SELECT @App9 = ApplicationId FROM LoanApplications WHERE ApplicationNumber LIKE '%00009';
    SELECT @App10 = ApplicationId FROM LoanApplications WHERE ApplicationNumber LIKE '%00010';
    SELECT @App11 = ApplicationId FROM LoanApplications WHERE ApplicationNumber LIKE '%00011';
    SELECT @App12 = ApplicationId FROM LoanApplications WHERE ApplicationNumber LIKE '%00012';
    SELECT @App13 = ApplicationId FROM LoanApplications WHERE ApplicationNumber LIKE '%00013';
    SELECT @App14 = ApplicationId FROM LoanApplications WHERE ApplicationNumber LIKE '%00014';
...
BEGIN CATCH
    ...
    PRINT 'ERROR: Sample data insertion failed - ' + ERROR_MESSAGE();
    THROW;
END CATCH
